...
<p align="center">
  <strong>Intégration Home Assistant pour Audi · VW · Škoda · SEAT · CUPRA · Porsche</strong>
</p>
...
> **Porsche & VW NA :** Les deux marques sont disponibles en Beta depuis v1.0.0. Porsche utilise Auth0 (distinct du VAG IDK), VW NA un serveur auth séparé. Testeurs recherchés — signalez vos retours via un [Issue](https://github.com/its-me-prash/vag-connect-ha/issues) !

---

## Fonctionnalités

### Tous les véhicules (70+ Entities)
